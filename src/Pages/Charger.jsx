    ...
    return (
        <section className="p-9 flex flex-col gap-20">
            <div className="flex flex-col gap-2">
                ...
                <p>¿Que tanto te gusta que el carro tenga puertos para cargar el celular?</p>
            </div>

            <form onSubmit={handleSubmit} className="flex flex-col gap-12">
                <div>                  
                    <label className="block" htmlFor="air">Escoge en una escala de 1 a 5</label>
